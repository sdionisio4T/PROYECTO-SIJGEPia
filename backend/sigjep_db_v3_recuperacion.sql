...
--
-- Host: 127.0.0.1    Database: sigjep_db
-- ------------------------------------------------------
...
CREATE TABLE `borradores_respuesta` (
  ...
  `estado` enum('pendiente','aprobado','modificado') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `pqrs` (
  ...
  `tipo` enum('peticion','queja','reclamo','sugerencia') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
-- Dump completed on 2026-04-27 19:58:29
